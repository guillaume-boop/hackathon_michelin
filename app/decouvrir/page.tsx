      ...
      <main className="flex-1 flex flex-col items-center h-full overflow-y-auto pb-28 lg:pb-0">
        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="sticky top-0 z-20 bg-white/95 dark:bg-black/95 backdrop-blur-xl px-4 pt-14 lg:pt-6 pb-4">
            <div className="flex items-center gap-3 bg-gray-100 dark:bg-neutral-900 rounded-2xl px-4 py-3  dark:border-white/[0.06]">
          ...
          {!isSearching && (
            <div className="px-4 pt-2">
              ...
              <div className="flex items-center gap-3 my-5">
                ...
                <span className="text-gray-400 dark:text-white/30 text-xs font-medium">ou</span>
                <div className="flex-1 h-px bg-gray-300 dark:bg-white/10" />
              </div>

              {/* Grille de filtres */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mb-4">
                <div className="bg-gray-100 dark:bg-neutral-900 rounded-2xl p-5 border border-gray-200 dark:border-white/[0.06]">
                  <p className="text-gray-600 dark:text-white/60 text-xs font-semibold leading-tight mb-3">Dans quelle ville ?</p>
                  <input
                    type="text"
                    value={pendingFilters.ville}
                    onChange={e => setPendingFilters(f => ({ ...f, ville: e.target.value }))}
                    placeholder="Votre réponse"
                    className="w-full bg-white dark:bg-white/5 rounded-xl px-3 py-3 text-gray-900 dark:text-white text-xs placeholder:text-gray-400 dark:placeholder:text-white/20 outline-none border border-gray-200 dark:border-white/5"
                  />
                </div>

                <div className="bg-gray-100 dark:bg-neutral-900 rounded-2xl p-5 border border-gray-200 dark:border-white/[0.06]">
                  <p className="text-gray-600 dark:text-white/60 text-xs font-semibold leading-tight mb-3">Quelle est loccasion ?</p>
                  <input
                    type="text"
                ...
                <div className="bg-gray-100 dark:bg-neutral-900 rounded-2xl p-5 border border-gray-200 dark:border-white/[0.06]">
                  <p className="text-gray-600 dark:text-white/60 text-xs font-semibold leading-tight mb-3">Quel est votre budget ?</p>
                  <div>
                    <input
                      type="range"
                      min={0}
                    ...
                    <div className="flex justify-between mt-2">
                      <span className="text-gray-500 dark:text-white/30 text-[10px]">0</span>
                      <span className="text-gray-900 dark:text-white/70 text-[10px] font-semibold">
                ...
                <div className="bg-gray-100 dark:bg-neutral-900 rounded-2xl p-5 border border-gray-200 dark:border-white/[0.06]">
                  <p className="text-gray-600 dark:text-white/60 text-xs font-semibold leading-tight mb-3">Que souhaitez-vous manger ?</p>
                  <input
                    type="text"
              ...
              {(() => {
                ...
                return (
                  <button
                    ...
                    disabled={!hasAny}
                    className="w-full py-4 rounded-2xl text-white font-bold text-sm transition-all mb-20 lg:mb-0"
                    style={{ background: hasAny ? '#E4002B' : 'rgba(0,0,0,0.08)', cursor: hasAny ? 'pointer' : 'default' }}
                  >
                    Valider
                  </button>
                )
