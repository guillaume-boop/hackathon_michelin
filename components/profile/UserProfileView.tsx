    ...
    <div className="flex h-screen bg-white dark:bg-black">
      ...
      <main className="flex-1 flex flex-col items-center h-full overflow-y-auto pb-28 lg:pb-0">
        ...
        <div className="w-full max-w-4xl">
            ...
            <div className="grid grid-cols-3 w-3/4">
              {[
                ...
                <div key={label} className="flex flex-col items-center gap-0">
                  <span className="text-base font-semibold text-gray-900 dark:text-gray-300">
                    {value}
                  </span>
          ...
          {isChef && chefData && (
            <>
              {chefData.restaurants && (
                <div className="mb-5">
                  <p className="text-gray-900 dark:text-white font-bold text-sm px-4 mb-2">Retrouvez moi au</p>
                  <Link
                    href={`/restaurant/${chefData.restaurants.id}`}
                    className="flex items-center gap-3 w-full px-4 py-1.5 transition-colors bg-gray-100 dark:bg-neutral-800"
                  >
                    <div
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5 min-w-0">
                        <p className="text-gray-900 dark:text-white font-black text-sm truncate">{chefData.restaurants.name}</p>
          ...
          {/* ── Tab bar ── */}
          <div className="flex border-t border-b border-gray-200 dark:border-white/[0.08]">
            {([
              {
                key: 'posts' as Tab,
                icon: (active: boolean) => (
              ...
              },
              {
                key: 'likes' as Tab,
                icon: (active: boolean) => (
                  <svg viewBox="0 0 24 24" fill={active ? '#D30792' : 'none'} stroke={active ? '#D30792' : 'currentColor'} strokeWidth={1.8} className="w-5 h-5 text-gray-500 dark:text-gray-400">
              ...
              },
              {
                key: 'saved' as Tab,
                icon: (active: boolean) => (
                  <svg viewBox="0 0 24 24" fill={active ? '#D34807' : 'none'} stroke={active ? '#D34807' : 'currentColor'} strokeWidth={1.8} className="w-5 h-5 text-gray-500 dark:text-gray-400">
              ...
              return (
                <button
                  ...
                  style={{ borderColor: isActive ? '#9ca3af' : undefined }}
                >
                  {icon(isActive)}
                </button>
              )
